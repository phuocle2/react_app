import React, { useEffect, useState, useContext, useCallback, request } from 'react';
...
const MainPage = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        if (event.target.name === 'btnDay1' && data.absence1 === '0') {
            data.absence1 = '1'
            // console.log(data.absence1)
        }

        if (event.target.name === 'btnDay2' && data.absence2 === '0') {
            data.absence2 = '1'
            ...
            <main>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td className='FieldTitle'>Absence</td>
                            <td >
                                {/* Submit button */}
                                <div className='btn'>
